...
evs = DosageRegimen(250)
subject = Subject(evs=evs)
...
sol_diffeq   = simobs(pbpkmodel,subject,param,y0,obstimes=0.0:0.1:600.0,tspan=(0.0,600.0))
println(sol_diffeq.derived)
